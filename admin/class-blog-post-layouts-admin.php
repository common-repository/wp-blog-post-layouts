                        ...
                        <ul>
                            ...
                            ?>
                                    <li class="nav-tab cv-nav-tab <?php echo esc_html( 'cv-'.$header_title ); if ( $header_title == 'dashboard' ){ echo esc_html( ' isActive' ); } ?>">
                                        <a href="<?php echo '#cv-'.esc_attr( $header_title ); ?>"><?php echo esc_html( str_replace( '-', ' ', $header_title ) ); ?>
                                            <span class="cv-nav-sub-title"><?php echo esc_html( $header_title_val['desc'] ); ?></span>
                                            <i class="<?php echo esc_attr( $header_title_val['icon'] ); ?>"></i>
                                        </a>
                                    </li>
                            <?php
                                }
                ...
                <div id="cv-main-content" class="cv-content-block-wrapper">
                    <?php
                        foreach( $header_titles as $header_title => $header_title_desc ) {
                            include( plugin_dir_path( __FILE__ ) .'partials/content-'.esc_attr( $header_title ).'.php' );
                        }
                    ?>
                </div><!-- #main-content -->
        ...
        ?>
            <div id="cv-plugin-admin-notice" class="notice updated is-dismissible">
                <div class="cv-plugin-message">
                    <?php
                        /* translators: %1$s is current user display name of translations */
                ...
                <div class="links">
                    <a href="<?php echo esc_url( 'https://wordpress.org/support/plugin/wp-blog-post-layouts/reviews/#new-post' ); ?>" class="btn button-primary" target="_blank">
                    ...
                    <a href="<?php echo esc_url( 'https://wordpress.org/support/plugin/wp-blog-post-layouts/' ); ?>" class="btn button-secondary" target="_blank">
