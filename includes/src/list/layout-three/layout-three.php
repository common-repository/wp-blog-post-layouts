    ...
    <div class="cv-post-wrapper <?php echo esc_attr( $postClass ); ?>">
        <?php
            ...
            if ( !empty( $postCategory ) && ( $posttype == 'post' ) ) {
                $list_post_args['cat'] = array( esc_attr( $postCategory ) );
                        ...
                        <div class="cv-post-thumb">
                            ...
                            <?php
                                if ( $dateOption ) {
                                    ...
                                    echo '<a href="'.esc_url( get_the_permalink() ).'">'.esc_html( get_the_date( 'd M' ) ).'</a>';
                                    echo '</div>';
                                }
                                ...
                                if ( $authorOption ) {                                    
                                    echo '<span class="cv-author-meta cv-post-meta-item" itemprop="author">';
                                        echo '<span class="cv-author-thumb">';
                                            echo '<img src="'.esc_url( $author_image ).'" alt="'.esc_attr( $author_display_name ).'"/>';
                                        echo '</span>';
